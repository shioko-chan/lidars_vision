...
use intelligent_sight_lib::{ImageBuffer, Reader, Searcher, Writer};
...
impl CamThread {
    pub fn new(stop_sig: Arc<AtomicBool>) -> Result<Self> {
        ...
        #[cfg(feature = "from_video")]
        {
            ...
            Ok(CamThread {
                shared_buffer: Writer::new(32, || ImageBuffer::new(1280, 1024))?,
                stop_sig,
    ...
    pub fn get_searcher(&self) -> Searcher<ImageBuffer> {
        self.shared_buffer.get_searcher()
    }
}
